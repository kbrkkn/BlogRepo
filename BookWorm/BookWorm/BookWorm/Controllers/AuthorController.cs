...
namespace BookWorm.Controllers
{
    public class AuthorController : Controller
    {
        ...
        public ViewResult Index(string sortOrder, string currentFilter, string searchString, int? page)
        {
            ...
            switch (sortOrder)
            {
                case "name_desc":
                    ...
                    break;
                case "Date":
                    authors = authors.OrderBy(s => s.EnrollmentDate);
                    break;
                case "date_desc":
                    authors = authors.OrderByDescending(s => s.EnrollmentDate);
                    break;
        ...
        public ActionResult Create([Bind(Include = "Lastname,Firstmidname,EnrollmentDate")] Author author)
        {
            try
            {
